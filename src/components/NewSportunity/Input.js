...
class Input extends PureComponent {
  ...
  render() {
    ...
    return (
      <div style={finalContainerStyle} ref={node => { this._containerNode = node; }} className={this.props.className ? this.props.className : ''}>
        <Style
          scopeSelector=".timeformatinput"
        ...
        {this.props.type === "textarea"
          ...
          : this.props.type === "number"
            ...
            : <input
              className={disabled ? 'inputClass' : null}
              style={error ? styles.inputError : readOnly ? this.state.isFocused ? styles.focusedInput : styles.readOnlyInput : this.props.className === "timeformatinput" ? styles.timedinput : styles.input}
              value={this.state.value}
              placeholder={placeholder}
              onChange={this._handleTextChange}
              readOnly={readOnly}
