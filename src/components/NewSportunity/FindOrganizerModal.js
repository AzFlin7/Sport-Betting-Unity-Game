...
// TODO props.relay.* APIs do not exist on compat containers
        this.props.relay.refetch({queryCircles: true});
                        ...
                        <div style={styles.modalContent}>
                            ...
                            :   openedModal === 2 
                                ...
                                :   openedModal === 3
                                    ...
                                    :   <div style={styles.content}>
                                            <div style={styles.inputContainer} ref={node => { this._inputNode = node }}>
                                                <span style={styles.explanation}>{localizations.newSportunity_organizerSelectCirclesExplanation}</span>
                                            </div>
                                            <div style={styles.circleList}>
                                                {circleList.length > 0
                                                ?   circleList.map((edge, index) => (
                                                    <div style={styles.circleContainer} key={index} onClick={() => this._handleSelectCircle(edge.node)}>
                                                        <div style={styles.circleDetails}>
                                                            <img style={styles.buttonImage} src="/images/icon_circle@3x.png"/>
                                                            <div style={styles.numberContainer}>
                                                                <span style={styles.number}>
                                                        ...
                                                        <InputCheckbox 
                                                            checked={this.state.selectedCircleList.findIndex(selectedCircle => selectedCircle.id === edge.node.id) >= 0}
                                                            onChange={(e) => {}}
                                                        />
                                                    </div>
                                                    ))
                                            ...
                                            <div style={this.state.selectedCircleList.length > 0 ? styles.bookOrganizer : styles.grayedBookOrganizer} onClick={this.validateCircleSelection}>
                                                {localizations.newSportunity_save}
                                            </div>
                                        </div>
                            }
...
// OK
    user: graphql`
        fragment FindOrganizerModal_user on User @argumentDefinitions(
    ...
    `,
    viewer: graphql`
        fragment FindOrganizerModal_viewer on Viewer @argumentDefinitions(
...
graphql`
query FindOrganizerModalRefetchQuery(
