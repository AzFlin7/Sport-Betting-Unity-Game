...
import Input from '../FindSportunity/Input';
...
class SportSelect extends PureComponent {
  ...
  render() {
    ...
    const { label, style, list, disabled, required, placeholder, stylesCustom } = this.props;
    ...
    const finalTriangleStyle = {
      ...triangleStyle,
      borderTopColor: disabled ?  '#D1D1D1' : open ? colors.green : '#212121',
    };
