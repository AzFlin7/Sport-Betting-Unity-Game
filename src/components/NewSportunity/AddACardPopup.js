...
class AddACardPopup extends PureComponent {
  constructor() {
    super();
    this.alertOptions = {
      offset: 60,
  ...
  _handleConfirm = (event) => {
    ...
    this.props.onConfirm(
      this.props.viewer.cardRegistration,
      {
        ...
        cardExpirationDate: this.state.cardExpires,
        cardCvx: this.state.cardCVC,
  ...
  render() {
   const { sportunity, onClose, me, viewer, processing, price } = this.props ;
    ...
    return (
      <div style={styles.pageContainer}>
        <div style={styles.container} id="popupContainer">
          ...
          <div style={styles.secondSubtitle}>
...
export default createRefetchContainer(Radium(withAlert(AddACardPopup)), {
  viewer: graphql`
    fragment AddACardPopup_viewer on Viewer @argumentDefinitions (
  ...
  graphql`
    query AddACardPopupRefetchQuery(
