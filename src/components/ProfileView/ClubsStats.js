...
export default createRefetchContainer(Radium(withRouter(ClubsStats)), {
//OK
    user: graphql`
        fragment ClubsStats_user on User @argumentDefinitions(
    ...
    `,
    viewer: graphql`
        fragment ClubsStats_viewer on Viewer @argumentDefinitions(
