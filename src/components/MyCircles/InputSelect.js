...
class InputSelect extends Component {
  ...
  _handleClickOnLink = () => {
    this.props._updateRegisterFromAction('/subaccounts-circle-creation/')
  ...
  render() {
    let { isDisabled, list, onSelectItem, selectedItem, placeholder, label, viewer, superMe } = this.props ;
          ...
          listIsOpen && 
            <div style={label ? styles.dropdownWithLabel : styles.dropdown}>
                <ul style={styles.list}>
                {
                  ...
                  { superMe && superMe.profileType && superMe.userPreferences && superMe.userPreferences.areSubAccountsActivated &&
                    <li onClick={this._handleClickOnLink} style={styles.listItem}>
...
export default connect(stateToProps,dispatchToProps)(withRouter(InputSelect));
