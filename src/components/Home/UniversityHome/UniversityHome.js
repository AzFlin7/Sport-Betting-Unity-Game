...
class UniversityHome extends Component {
  ...
  renderMetaTags = () => {
    return <Helmet>
              <title>{localizations.meta_title_university}</title>
              <meta name="description" content={localizations.meta_desc_university}/>
              <meta name="keywords" content={localizations.metea_keywords_clubs}/>
              <meta property="fb:app_id" content="1759806787601548"/>
              <meta property="og:type" content="website"/>
              <meta property="og:title" content={localizations.meta_title_university} />
              <meta property="og:description" content={localizations.meta_desc_university}/>
    ...
    return (
      <div style={styles.container}>
        ...
        <HeaderImage 
          ...
          title={localizations.homeUniversities_headerTextMaj}
          subTitle={localizations.homeUniversities_headerTextMin}
...
const ReduxContainer = connect(stateToProps,dispatchToProps)(Radium(UniversityHome));
