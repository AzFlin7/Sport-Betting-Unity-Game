...
class CompaniesHome extends Component {
  ...
  renderMetaTags = () => {
    return <Helmet>
              <title>{localizations.meta_title_companies}</title>
              <meta name="description" content={localizations.meta_desc_companies}/>
              <meta name="keywords" content={localizations.meta_keywords_companies}/>
              <meta property="fb:app_id" content="1759806787601548"/>
              <meta property="og:type" content="website"/>
              <meta property="og:title" content={localizations.meta_title_companies} />
              <meta property="og:description" content={localizations.meta_desc_companies}/>
  ...
  handleClick = () => {
    if (this.props.viewer.me && this.props.viewer.me.id) {
      ...
      this.props._updateRegisterFromAction('profileType/BUSINESS');
      setTimeout(() => {
    ...
    return (
      <div style={styles.container}>
        ...
        <HeaderImage 
          ...
          backgroundImage={'url("/images/background-companies.jpg")'}
          videoId={'dNEiRugZCA4'}
          title={localizations.homeCompanies_headerTextMaj}
          subTitle={localizations.homeCompanies_headerTextMin}
          registerText={localizations.homeCompanies_createAccount}
...
const ReduxContainer = connect(stateToProps,dispatchToProps)(Radium(CompaniesHome));
