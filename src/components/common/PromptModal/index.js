                ...
                >
                    <div style={styles.modalContent} ref={node => { this._containerNode = node; }}>
                        ...
                        <textarea 
                            ...
                            style={{margin: '20px 0px', borderColor: colors.darkGray}}
                        />
                        <div style={styles.buttonRow}>
                            ...
                            {!this.state.isLoading && 
                                <button 
                                    onClick={() => {
                                        this.setState({isLoading: true}); 
                                        this.props.onConfirm(this.state.commentText); 
                                        setTimeout(() => {
                                            this._closeModal()
                                        }, 2000)
                                    }} 
...
export default Radium(PromptModal);

export function openPromptModal(properties) {
    document.body.children[0].classList.add('react-confirm-alert-blur');
    const divTarget = document.createElement('div');
    divTarget.id = 'react-confirm-alert';
    document.body.appendChild(divTarget);
    render(<PromptModal {...properties} isOpen={true} />, divTarget);
}