          ...
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_create_teams}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_create_teams_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_give_access}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_give_access_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_create_groups}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_create_groups_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_organize_activity}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_organize_activity_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_stats}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_stats_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_form}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_form_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_subscription}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_subscription_description_1}
              </div>
            </div>
        ...
        <ListItem button>
          <div style={styles.listItemWrapper}>
            ...
            <div style={styles.stepTextContainer} onClick={() => {
              ...
              <div style={styles.stepTitle}>
                {localizations.stepper_modal_company_documents}
              </div>
              <div style={styles.stepDescription}>
                {localizations.stepper_modal_company_documents_description_1}
              </div>
            </div>
