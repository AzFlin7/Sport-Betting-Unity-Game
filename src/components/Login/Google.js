...
class Google extends React.Component {
  ...
  _onGoogleResponse = (data) => {
    // this._loginFacebook(user_data.tokenDetail.accessToken)
  ...
  _loginGoogle = async (googleToken) => {
    ...
    if (response && response.success) {
      ...
      setTimeout(() => {
        this.props.trackLogin('Login-Google')
    ...
    return(
      <div style={styles.container}>
          ...
          <GoogleLogin
            ...
            buttonText={localizations.login_loginGoogle}
